...
public class PanelCenter
{
	...
	public static void init(Simulator simulator)
	{
        ...
        handBrakeIndicator = new Picture("handBrakeIndicator");	// "handBrakeIndicatorSmall.png"
        handBrakeIndicator.setImage(sim.getAssetManager(), "Textures/Gauges/test_img.png", true);
