...
public class SimulationBasics extends SimpleApplication 
{
    ...
    {    	
        ...
        // try to enable screenshots
        String filePath = "C:"+File.separator+"Users"+File.separator+"carsim"+File.separator+"Desktop"+File.separator+
    			"dcg_test_builds"+File.separator+"ods_test_build"+File.separator+"OpenDS_4.5_test"+File.separator+"Screenshots"+File.separator;
        ScreenshotAppState screenShotState = new ScreenshotAppState(filePath, "Center Test ", 0);
